...
export const BeFamiliarWithmics = ()=>(
    <>
        <Header/>
            ...
            <div className='pt-5' style={{margin:'0px 100px'}}>
                <div className='row'>
                    <div className='col-lg-9 mb-5'>
                        <div className='text-center'>
                            ...
                            <div className='py-3' style={{background:'white', width:'90%', marginRight:'47px'}}>
                                <p>تولید محتوا</p>
                                <h3 className='text-success' style={{fontWeight:'bold'}}>آشنایی با انواع الگوهای قطبی میکروفن‌ها</h3>
                                <CenterDivider 
                                    width='50px'
                                    color='gray'
                                />
                                <p>زمان مطالعه : 6 دقیقه</p>
                                <img 
                                ...
                                <div className='px-4' style={{textAlign:'right', fontSize:'18px'}}>
                                    <p>
                                    الگوی قطبی همه جهته (چند جهتی) در میکروفن‌ها، الگویی است که باعث می‌شود میکروفن از هر جهت نسبت به صداها حساسیت داشته باشد و بتواند از شعاع 360 درجه‌ای اطراف خود صداها را دریافت کند.
                                    </p>
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>۱. الگوی قطبی تمام جهتی  (Omnidirectional)   </h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>مزیت میکروفن‌های Omnidirectional</h5>
                                    <p>
                                    اگر مایلید صدایی طبیعی ضبط کنید، به‌ویژه اگر از منشا صدا فاصله‌ای هم دارید، میکروفن‌های چندجهته گزینه‌ای بسیار مناسب برای شما هستند؛ زیرا این میکروفن‌ها با عدم اثربخشی بر محور
                                     فرکانس طبیعی صدایتان به شما این توانایی را می‌دهند تا صدا را از همه زوایا دقیق و طبیعی ضبط کنید.
                                    </p>
                    ...
                    <div className='col-lg-3 py-4 rounded' style={{background:'white', height:'50%'}} >
                        <img src='img/ads.jpg' style={{width:'300px', height:'300px'}}  alt='' />
                        <h5 className='mt-3' style={{fontWeight:'bold'}}>این مطلب را هم بخوانید</h5>
                        <RightDivider 
                            width='30px'
                        />
                        <img className='mt-3' src='img/ContentMarketingTips.jpg' style={{width:'300px', height:'170px'}} alt='' />
                        <h5 className='mt-4'>هشت نکته مهم درباره بازاریابی محتوا</h5>
                        <img className='mt-3' src='img/InstagraMarketing.jpg' style={{width:'300px', height:'170px'}} alt='' />
                        <h5 className='mt-4'>11 روند مهم بازاریابی اینستاگرام</h5>
                        <img className='mt-3' src='img/PresentationTips.jpg' style={{width:'300px', height:'170px'}} alt='' />
                        <h5 className='mt-4'>نکاتی درباره سخنرانی خوب</h5>
                        <img className='mt-3' src='img/Rework-book-summary.jpg' style={{width:'300px', height:'170px'}} alt='' />
