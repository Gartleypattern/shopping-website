                    ...
                    <div className='col-lg-9 mb-5'>
                        <div className='text-center'>
                            ...
                            <div className='py-3' style={{background:'white', width:'90%', marginRight:'47px'}}>
                                <p>سئو</p>
                                <h3 className='text-success' style={{fontWeight:'bold'}}>رتبه بالا در گوگل</h3>
                                <CenterDivider 
                                    width='50px'
                                    color='gray'
                                />
                                ...
                                <div className='px-4' style={{textAlign:'right', fontSize:'18px'}}>
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>1.خزنده</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>2.ایندکس</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>3.الگوریتم</h5>
