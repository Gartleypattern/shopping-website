                        ...
                        <div className='text-center'>
                            ...
                            <div className='py-3' style={{background:'white', width:'90%', marginRight:'47px'}}>
                                ...
                                <div className='px-4' style={{textAlign:'right', fontSize:'18px'}}>
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>1.قبل از شروع خودت را آموزش بده</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>2.ایده خودت را به یک مدل کسب و کار تبدیل کنید</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>3.یک طرح کسب و کار ناب بسازید</h5>
