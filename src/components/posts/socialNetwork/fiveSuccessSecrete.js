                        ...
                        <div className='text-center'>
                            ...
                            <div className='py-3' style={{background:'white', width:'90%', marginRight:'47px'}}>
                                ...
                                <div className='px-4' style={{textAlign:'right', fontSize:'18px'}}>
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>1.هدف داشتن</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>2.برنامه ریزی</h5>
                                    ...
                                    <h5 className='text-success' style={{fontWeight:'bold'}}>3.نظم</h5>
