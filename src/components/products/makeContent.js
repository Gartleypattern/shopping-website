...
export const MakeContent = () =>(
    <>
        ...
        <div className='container-fluid' style={{background:'#F6F6F6'}}>
           <ProductSummary 
                title='تولید سریع محتوا'
                priceTitle= '120000 هزار تومان'
                p1= 'تهیه کننده : ژان بقوسیان'
                p3= 'فرمت فیلم : MP4 دانلودی'
                src='img/MMI32323.jpg'
           />
        </div> 
                ...
                <div className='row px-2'>
                    <div className='col-xl-10 offset-xl-1'>
                        ...
                        <div className='text-center text-success'>
                            <h3 style={{fontWeight:'bold'}}>تولید سریع محتوا</h3>
                            <h5 style={{fontWeight:'bold'}}> مراحل تولید سریع محتوا</h5>
                        </div>
