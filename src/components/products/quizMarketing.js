           ...
           />
            ...
            <div className='mb-3' style={{background:'white',padding:'30px 120px'}}>
                ...
                <div className='text-center text-success'>
                    <h3 style={{fontWeight:'bold'}}>فیلم کوئیز مارکتینگ مارکتینگ</h3>
                    <h5 style={{fontWeight:'bold'}}>بررسی تاثیر کوئیز در مارکتینگ</h5>
                </div>
