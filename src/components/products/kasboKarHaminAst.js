...
export const KasboKarHaminAst = () =>(
    <>
        <Header/>
        <div className='container-fluid' style={{background:'#F6F6F6'}}>
           <ProductSummary 
            title='کتاب کسب و کار همین است'
            priceTitle= '29000 هزار تومان'
            p1= 'نویسنده : ژان بقوسیان'
            p2= 'فرمت کتاب رقعی در 112 صفحه'
            p3= 'فرمت صوت : MP3 دانلودی'
            P4='انتشارات : کلید آموزش'
            p5= 'نوبت چاپ : اول'
            p6= 'سال نشر: تابستان 1400'
            src='img/BusinessBookandAudio.jpg'
           />
        </div> 
                ...
                <div className='row px-2'>
                    <div className='col-xl-10 offset-xl-1'>
                        ...
                        <div className='text-center text-success'>
                            <h3 style={{fontWeight:'bold'}}>کسب و کار همین است</h3>
                            <h5 style={{fontWeight:'bold'}}>نگاهی ساده به اجزای کلیدی کسب و کار</h5>
                        </div>
