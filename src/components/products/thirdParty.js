...
export const ThirdParty = () =>(
    <>
        ...
        <div className='container-fluid' style={{background:'#F6F6F6'}}>
           <ProductSummary 
                title='سومین همایش مدرسان مرجع'
                priceTitle= '500000 هزار تومان'
                p1= 'تهیه کننده : ژان بقوسیان'
                p3= 'فرمت فیلم : MP4 دانلودی'
                src='img/mmi3_product.jpg'
           />
        </div> 
                ...
                <div className='row px-2'>
                    <div className='col-xl-10 offset-xl-1'>
                        ...
                        <div className='text-center text-success'>
                            <h3 style={{fontWeight:'bold'}}>سومین همایش مدرسان مرجع</h3>
                            <h5 style={{fontWeight:'bold'}}> جزئیات همایش مدرسان مرجع</h5>
                        </div>
